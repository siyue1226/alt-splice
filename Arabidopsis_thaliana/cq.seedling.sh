...
echo "* Start cuffquant [seedling] [SRR6179908] `date`" | tee -a /home/wangq/data/rna-seq/Ath_trans/log/cuffquant.log
...
/home/wangq/bin/cuffquant -p 8 \
    ...
    -o /home/wangq/data/rna-seq/Ath_trans/process/SRR6179908/cq_out \
    /home/wangq/data/rna-seq/Ath_trans/process/SRR6179908/th_out/accepted_hits.bam

[ $? -ne 0 ] && echo `date` seedling SRR6179908 [cuffquant] failed >> /home/wangq/data/rna-seq/Ath_trans/fail.log && exit 255
echo "* End cuffquant [seedling] [SRR6179908] `date`" | tee -a /home/wangq/data/rna-seq/Ath_trans/log/cuffquant.log
