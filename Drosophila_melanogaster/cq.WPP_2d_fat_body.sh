...
echo "* Start cuffquant [WPP_2d_fat_body] [SRR070429] `date`" | tee -a /home/wangq/data/rna-seq/dmel_trans/log/cuffquant.log
...
/home/wangq/bin/cuffquant -p 8 \
    ...
    -o /home/wangq/data/rna-seq/dmel_trans/process/WPP_2d_fat_body/SRR070429/cq_out \
    /home/wangq/data/rna-seq/dmel_trans/process/WPP_2d_fat_body/SRR070429/th_out/accepted_hits.bam

[ $? -ne 0 ] && echo `date` WPP_2d_fat_body SRR070429 [cuffquant] failed >> /home/wangq/data/rna-seq/dmel_trans/fail.log && exit 255
echo "* End cuffquant [WPP_2d_fat_body] [SRR070429] `date`" | tee -a /home/wangq/data/rna-seq/dmel_trans/log/cuffquant.log
