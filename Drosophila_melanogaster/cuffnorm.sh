...
# cuffdiff_cxb
#----------------------------#
echo "* Start cuffnorm `date`" | tee -a /home/wangq/data/rna-seq/dmel_trans/log/cuffmergediff.log
...
/home/wangq/bin/cuffnorm -p 14 \
    ...
    -o /home/wangq/data/rna-seq/dmel_trans/process/norm_out

[ $? -ne 0 ] && echo `date` ] [cuffnorm] failed >> /home/wangq/data/rna-seq/dmel_trans/fail.log && exit 255
echo "* End cuffnorm `date`" | tee -a /home/wangq/data/rna-seq/dmel_trans/log/cuffmergediff.log
