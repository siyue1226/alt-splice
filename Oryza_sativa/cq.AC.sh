...
echo "* Start cuffquant [OSN_AC] [SRR352189] `date`" | tee -a /home/wangq/data/rna-seq/rice_trans/log/cuffquant.log
...
/home/wangq/bin/cuffquant -p 8 \
    ...
    -o /home/wangq/data/rna-seq/rice_trans/process/SRR352189/cq_out \
    /home/wangq/data/rna-seq/rice_trans/process/SRR352189/th_out/accepted_hits.bam

[ $? -ne 0 ] && echo `date` OSN_AC SRR352189 [cuffquant] failed >> /home/wangq/data/rna-seq/rice_trans/fail.log && exit 255
echo "* End cuffquant [OSN_AC] [SRR352189] `date`" | tee -a /home/wangq/data/rna-seq/rice_trans/log/cuffquant.log
