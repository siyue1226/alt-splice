...
echo "* Start cuffquant [OSN_BH] [SRR352209] `date`" | tee -a /home/wangq/data/rna-seq/rice_trans/log/cuffquant.log
...
/home/wangq/bin/cuffquant -p 8 \
    ...
    -o /home/wangq/data/rna-seq/rice_trans/process/SRR352209/cq_out \
    /home/wangq/data/rna-seq/rice_trans/process/SRR352209/th_out/accepted_hits.bam

[ $? -ne 0 ] && echo `date` OSN_BH SRR352209 [cuffquant] failed >> /home/wangq/data/rna-seq/rice_trans/fail.log && exit 255
echo "* End cuffquant [OSN_BH] [SRR352209] `date`" | tee -a /home/wangq/data/rna-seq/rice_trans/log/cuffquant.log
